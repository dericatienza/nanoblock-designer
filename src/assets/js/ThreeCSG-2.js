...
THREE.CSG = {
  toCSG: function (three_model, offset, rotation) {
    ...
    for (i = 0; i < geometry.faces.length; i++) {
      ...
      //     vertices = [];
      //     vertices.push(new CSG.Vertex(rotation_matrix.applyMatrix4(geometry.vertices[geometry.faces[i].a].position.clone().addSelf(offset)), [geometry.faces[i].normal.x, geometry.faces[i].normal.y, geometry.faces[i].normal.z]));
      //     vertices.push(new CSG.Vertex(rotation_matrix.applyMatrix4(geometry.vertices[geometry.faces[i].b].position.clone().addSelf(offset)), [geometry.faces[i].normal.x, geometry.faces[i].normal.y, geometry.faces[i].normal.z]));
      //     vertices.push(new CSG.Vertex(rotation_matrix.applyMatrix4(geometry.vertices[geometry.faces[i].d].position.clone().addSelf(offset)), [geometry.faces[i].normal.x, geometry.faces[i].normal.y, geometry.faces[i].normal.z]));
      //     polygons.push(new CSG.Polygon(vertices));

      //     vertices = [];
      //     vertices.push(new CSG.Vertex(rotation_matrix.applyMatrix4(geometry.vertices[geometry.faces[i].b].position.clone().addSelf(offset)), [geometry.faces[i].normal.x, geometry.faces[i].normal.y, geometry.faces[i].normal.z]));
      //     vertices.push(new CSG.Vertex(rotation_matrix.applyMatrix4(geometry.vertices[geometry.faces[i].c].position.clone().addSelf(offset)), [geometry.faces[i].normal.x, geometry.faces[i].normal.y, geometry.faces[i].normal.z]));
      //     vertices.push(new CSG.Vertex(rotation_matrix.applyMatrix4(geometry.vertices[geometry.faces[i].d].position.clone().addSelf(offset)), [geometry.faces[i].normal.x, geometry.faces[i].normal.y, geometry.faces[i].normal.z]));
      //     polygons.push(new CSG.Polygon(vertices));
